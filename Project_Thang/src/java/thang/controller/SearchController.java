...
public class SearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            float minPrice = Float.parseFloat(request.getParameter("txtMinValue"));
            float maxPrice = Float.parseFloat(request.getParameter("txtMaxValue"));
            request.setAttribute("MIN", minPrice);
            request.setAttribute("MAX", maxPrice);
            Tbl_watchDAO dao  = new Tbl_watchDAO();
            List<Tbl_watchDTO> listSearch = dao.findByPrice(minPrice, maxPrice);
