<%-- 
    Document   : manageSearchProduct
    Created on : 23-Aug-2018, 1:26:35 PM
    Author     : CaoThu
--%>
        ...
        <div id="ttr_page" class="container">
                    ...
                    <div class="ttr_headershape02">
                        <div class="html_content">
                            <p style="margin:0.36em 0em 0.36em 0em;">
                                <span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Manage Product</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    <form class="form-horizontal" action="searchProductName" style="width: 40%">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Product ID/Name:</label>
                            <div class="col-sm-6">
                                <input name="txtProductName" type="text" class="form-control" value="${param.txtProductName}"
                ...
                <div id="ttr_content">
                    <div id="ttr_content_margin"class="container-fluid">
                        ...
                        <div class="ttr_Projects_html_row0 row" style="padding-top: 10px">
                            <a class="btn btn-danger" href="manageInsertProduct.GOTOJSP">Insert Product</a>
                            <c:set var="searchProduct" value="${requestScope.LIST_SEARCH_PRODUCT}"/>
                            <c:if test="${not empty searchProduct}">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach var="dto" items="${searchProduct}" varStatus="counter">
                                            <tr>
                                                <td>
                                                    ${counter.count}
                                                </td>
                                                ...
                                                <td>
                                                    <img src="${dto.picture}" width="300" height="200" alt="Picture"/>
                                                </td>
                                                <td>
                                                    ${dto.description}
                                                </td>
