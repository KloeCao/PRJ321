...
//            Information Customer
            ...
            CustomerDTO infoCus = cusDAO.informationCust(custID);
            String cusName = cusDAO.custName(custID);
            ...
            request.getRequestDispatcher("checkOutInformation.jsp").forward(request, response);
        }
    }
