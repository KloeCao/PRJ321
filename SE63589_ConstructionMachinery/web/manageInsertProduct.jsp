<%-- 
    Document   : manageInsertProduct
    Created on : 23-Aug-2018, 9:52:54 PM
    Author     : CaoThu
--%>
        ...
        <div id="ttr_page" class="container">
                    ...
                    <div class="ttr_headershape02">
                        <div class="html_content">
                            <p style="margin:0.36em 0em 0.36em 0em;">
                                <span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Insert Product</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    <c:set var="errors" value="${requestScope.INSERT_PRODUCT_ERROR}" />
                    <form class="form-horizontal" method="POST" action="insertProduct" enctype="multipart/form-data" style="width: 40%">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Machine ID*:</label>
                            <div class="col-sm-8">
                                <input name="txtMachineID" type="text" class="form-control" value="${param.txtMachineID}"
                                       style="height: 28px !important; position: relative; top: 3px" />
                            </div>
                            <div class="col-sm-4"></div>
                            <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                <c:if test="${not empty errors.errMachineID}">
                                    ${errors.errMachineID}
                                </c:if>
                                <c:if test="${not empty errors.errMachineIDExist}">
                                    ${errors.errMachineIDExist}
                                </c:if>
                            </label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Picture*:</label>
                            <div class="col-sm-8">
                            ...
                            <div class="col-sm-4"></div>
                            <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                <c:if test="${not empty errors.errPicture}">
                                    ${errors.errPicture}
                                </c:if>
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="chkSale" type="checkbox"
                                       <c:if test="${not empty param.chkSale}"> checked </c:if>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <c:if test="${not empty param.chkUnavailable}"> checked </c:if>
                                        style="height: 20px !important; position: relative;" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12" style="display: flex;justify-content: flex-end;">
                                    <input type="hidden" name="txtDate" value="${sessionScope.DATE}" /><br/>
                                <input type="submit" class="btn btn-md btn-primary" value="Create"
