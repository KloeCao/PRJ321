        ...
        <div id="ttr_page" class="container">
            ...
            <header id="ttr_header" class="content">
                <div id="ttr_header_inner">
                    <div class="ttr_headershape02">
                        <div class="html_content"><p style="margin:0.36em 0em 0.36em 0em;"><span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Register</span></p></div>
                    </div>
                </div>
            </header>
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    ...
                    <form class="form-horizontal" action="register" method="POST" style="width: 40%">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Account ID*:</label>
                            <div class="col-sm-8">
                                <input name="txtAccountID" type="text" class="form-control" value="${param.txtAccountID}"
                                       style="height: 28px !important; position: relative; top: 3px" />
                            </div>
                            <div class="col-sm-4"></div>
                            <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                <c:if test="${not empty errors.errAccID}">
                                    ${errors.errAccID}
                                </c:if>
                            </label>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Full Name*:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Confirm Password*:</label>
                            <div class="col-sm-8">
                                <input name="txtConfirm" type="password" class="form-control"
                                       style="height: 28px !important; position: relative; top: 3px" />
                            </div>
                            <div class="col-sm-4"></div>
                            <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                <c:if test="${not empty errors.errConfirm}">
                                    ${errors.errConfirm}
                                </c:if>
                            </label>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Phone Number*:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12" style="display: flex;justify-content: flex-end;">
                                ...
                                <input type="submit" class="btn btn-md btn-primary" rows="4" value="Register"
