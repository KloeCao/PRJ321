 ...
 * @author Kim Anh
 */
public class UpdateCustomerByAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(update) {
                request.setAttribute("UPDATE_INFOR", "This information is updated.");
            } else {
                request.setAttribute("UPDATE_INFOR", "Sorry! Cannot update this account information.");
            }
        } catch (Exception e) {
            log("Error at UpdateCustomerByAdminController: " + e.getMessage());
        } finally {
