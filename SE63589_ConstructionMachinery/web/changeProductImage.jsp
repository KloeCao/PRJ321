<%-- 
    Document   : changeProductImage
    Created on : Aug 29, 2018, 8:38:37 AM
    Author     : CaoThu
--%>
...
<html>
    ...
    <body class="KHome Home Projects">
        ...
        <div id="ttr_page" class="container">
                    ...
                    <div class="ttr_headershape02">
                        <div class="html_content">
                            <p style="margin:0.36em 0em 0.36em 0em;">
                                <span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Change Product Picture</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 100px; flex-wrap: wrap">
                    <form class="form-horizontal" method="POST" action="changeProductImage" enctype="multipart/form-data" style="width: 40%">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Machine ID*:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control disabled" value="${param.machineID}" disabled
                                       style="height: 28px !important; position: relative; top: 3px" />
                                <input type="hidden" name="proId" value="${param.machineID}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Current Picture:</label>
                            <div class="col-sm-8" style="text-align: right">
                                <img src="${param.img}" width="200" style="float: left" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Choose an image:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12" style="display: flex;justify-content: flex-end;">
                                <input type="submit" class="btn btn-md btn-primary" value="Save change"
