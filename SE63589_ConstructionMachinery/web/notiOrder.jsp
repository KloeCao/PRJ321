<%-- 
    Document   : notiOrder
    Created on : 25-Aug-2018, 8:53:39 PM
    Author     : CaoThu
--%>
            ...
            <header id="ttr_header" class="content">
                <div id="ttr_header_inner">
                    <div class="ttr_headershape02" style="width: calc(100% - 100px)">
                        <div class="html_content"><p style="margin:0.36em 0em 0.36em 0em;"><span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Your order is sent to supplier!</span></p></div>
                    </div>
                </div>
            </header>
