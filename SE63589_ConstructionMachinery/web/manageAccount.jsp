<%-- 
    ...
    Created on : 22-Aug-2018, 6:42:24 PM
    Author     : CaoThu
--%>
                ...
                <div id="ttr_content">
                    <div id="ttr_content_margin"class="container-fluid">
                        ...
                        <div class="ttr_Projects_html_row0 row" style="padding-top: 10px">
                            ...
                            <c:set var="allAccount" value="${requestScope.LIST_ACCOUNT}" />
                            <c:if test="${not empty allAccount}">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach var="dto" items="${allAccount}" varStatus="counter">
                                            <tr>
                                                <td>
                                                    ${counter.count}
                                                </td>
