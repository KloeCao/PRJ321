<%-- 
    Document   : cart
    Created on : 24-Aug-2018, 5:06:51 PM
    Author     : CaoThu
--%>
                    ...
                    <div class="ttr_headershape02">
                        <div class="html_content">
                            <p style="margin:0.36em 0em 0.36em 0em;">
                                <span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Your Cart</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="ttr_content_margin"class="container-fluid">
                        ...
                        <div class="ttr_Projects_html_row0 row" style="padding-top: 10px">
                            ...
                            <c:if test="${not empty cart}">
                                <c:set var="list" value="${requestScope.PRODUCT_BUY}" />
                                <c:if test="${not empty list}">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="dto" items="${list}" varStatus="counter">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="${dto.picture}" width="300" height="200"/>
                                                    </td>
                                                    <td>
                                                        ${dto.machineName}
                                                    </td>
                                                    <td>
                                                        <c:set var="quantity" value="${cart.items[dto.machineID]}" />
                                                        ${quantity}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <form action="removeItem">
                                                            <input type="hidden" name="machineID" value="${dto.machineID}" />
                                                            <input type="submit" value="Remove" class="btn btn-md btn-default"
                                    ...
                                    <form action="checkout">
                                        <input type="submit" value="Checkout" class="btn btn-danger"
                                               style="float: right; padding: 10px 20px; margin: 0 0 0 10px; font-size: 20px; position: relative; top: 3px;"
                                               />
                                    </form>
                                </c:if>
                            ...
                            <a href="showMachine" style="color: #3497DA">Add more to cart</a>
                        </div>
                    </div>
