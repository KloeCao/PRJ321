                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                                <h3>${param.journey}</h3>
                                <p>${param.timeBegin} ~ ${param.timeEnd}</p>
                                <p>${param.timeLiving}</p>
                            </div>
                        </div>
                        <div class="row">
                            <c:if test="${not empty requestScope.PASSENGER_OF_TOUR}">
                                <table class="row">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.PASSENGER_OF_TOUR}" var="passenger" varStatus="number">
                                            <tr>
                                                <td>${number.count}</td>
                                                ...
                                                <td>
                                                    <input type="checkbox" checked="${passenger.isAdult}" readonly="true"/>                                                    
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
