...
public class FilterDispatcher implements Filter {
    ...
    private final String showAllPage = "ShowMachineController";
        ...
        try {
            ...
            if (resource.length() > 0) {
                ...
                if (resource.contains(".")) {
                    if (resource.lastIndexOf(".GOTOJSP") > 0) {
                        url = resource.substring(0, resource.indexOf(".GOTOJSP")) + ".jsp";
                    } else if (resource.lastIndexOf(".FORM") > 0) {
                        url = resource.substring(0, resource.indexOf(".FORM")) + ".html";
                    } else {
                        url = resource;
                    }
                }
