 ...
 * @author Kim Anh
 */
public class InsertTouguideByAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean insert = dao.insert(tourguide);
            if(insert) {
                request.setAttribute("INSERT", username + " account is created");
            } else {
                request.setAttribute("INSERT", "Sorry! TourGuide Information can not save. Please update information in another time.");
            }
        } catch (Exception e) {
