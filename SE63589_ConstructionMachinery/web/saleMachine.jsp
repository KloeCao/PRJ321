<%-- 
    Document   : saleMachine
    Created on : 21-Aug-2018, 1:35:22 PM
    Author     : CaoThu
--%>
        ...
        <div id="ttr_page" class="container">
                    ...
                    <div id="navigationmenu">
                        ...
                        <div class="menu-center collapse navbar-collapse">
                            ...
                            <ul class="ttr_menu_items nav navbar-nav navbar-right">
                                ...
                                <li class="ttr_menu_items_parent dropdown"><a href="showSale" class="ttr_menu_items_parent_link_active"><span class="menuchildicon"></span>Sale</a>
                                    <hr class ="horiz_separator"/>
                                </li>
            ...
            <header id="ttr_header" class="content">
                <div id="ttr_header_inner">
                    <div class="ttr_headershape02">
                        <div class="html_content"><p style="margin:0.36em 0em 0.36em 0em;"><span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Hello Sale Machinery World!</span></p></div>
                    </div>
                </div>
            </header>
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    <form id="searchAllByName" class="form-horizontal" action="searchSaleByName" style="width: 51%">
                        <div class="form-group">
                            <label class="col-sm-2 control-label" style="padding-right: 0; padding-left: 10px">Search Name:</label>
                            <div class="col-sm-7">
                                <input name="txtSearchByName" type="text" class="form-control"
                    ...
                    <form id="searchAllByPrice" class="form-horizontal" action="searchSaleByPrice" style="width: 51%">
                        <div class="form-group">
                            <label class="col-sm-2 control-label" style="padding-right: 0; padding-left: 10px">Price from:</label>
                            <div class="col-sm-3">
                                <input name="txtMinPrice" type="text" class="form-control"
                                       style="height: 28px !important; position: relative; top: 3px" />
                            </div>
                            <label class="col-sm-1 control-label" style="padding-right: 0; padding-left: 10px"> to:</label>
                            <div class="col-sm-3">
                                <input name="txtMaxPrice" type="text" class="form-control" style="height: 28px !important; position: relative;
                                       top: 3px" />
                            </div>
                            <div class="col-sm-3">
                                <input type="submit" class="btn btn-md btn-primary" rows="4" value="Search"
