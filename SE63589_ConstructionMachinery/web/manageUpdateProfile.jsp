<%-- 
    ...
    Created on : 23-Aug-2018, 1:49:46 PM
    Author     : CaoThu
--%>
        ...
        <div id="ttr_page" class="container">
                    ...
                    <div class="ttr_headershape02">
                        <div class="html_content">
                            <p style="margin:0.36em 0em 0.36em 0em;">
                                <span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:2.286em;color:rgba(52,152,219,1);">Update Account</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    <c:set var="dto" value="${sessionScope.ACCOUNT_UPDATE}"/>
                    <c:set var="errors" value="${requestScope.UPDATE_ACCOUNT_ERROR}"/>
                    <c:if test="${not empty dto}">
                        <form class="form-horizontal" method="POST" action="confirmUpdateProfile" style="width: 40%">
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Account ID:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control disabled" value="${dto.accountID}" disabled
                                           style="height: 28px !important; position: relative; top: 3px" />
                                    <input type="hidden" name="txtAccountID" value="${dto.accountID}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Password*:</label>
                                <div class="col-sm-8">
                                ...
                                <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                    <c:if test="${not empty errors.errPassword}">
                                        ${errors.errPassword}
                                    </c:if>
                                </label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Account Name*:</label>
                                <div class="col-sm-8">
                                    <c:if test="${param.txtAccountName == null}">
                                        <input name="txtAccountName" type="text" class="form-control" value="${dto.accountName}"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                    <c:if test="${param.txtAccountName != null}">
                                        <input name="txtAccountName" type="text" class="form-control" value="${param.txtAccountName}"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                </div>
                                <div class="col-sm-4"></div>
                                <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                    <c:if test="${not empty errors.errAccName}">
                                        ${errors.errAccName}
                                    </c:if>
                                </label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Phone*:</label>
                                <div class="col-sm-8">
                                    <c:if test="${param.txtPhone == null}">
                                        <input name="txtPhone" type="text" class="form-control" value="${dto.numberPhone}"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                    <c:if test="${param.txtPhone != null}">
                                        <input name="txtPhone" type="text" class="form-control" value="${param.txtPhone}"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                </div>
                                <div class="col-sm-4"></div>
                                <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                    <c:if test="${not empty errors.errPhone}">
                                        ${errors.errPhone}
                                    </c:if>
                                </label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Address*:</label>
                                <div class="col-sm-8">
                                    <c:if test="${param.txtAddress == null}">
                                        <input name="txtAddress" type="text" class="form-control" value="${dto.address}"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                    <c:if test="${param.txtAddress != null}">
                                        <input name="txtAddress" type="text" class="form-control" value="${param.txtAddress}"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                </div>
                                <div class="col-sm-4"></div>
                                <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                    <c:if test="${not empty errors.errAddress}">
                                        ${errors.errAddress}
                                    </c:if>
                                </label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="padding-right: 0; padding-left: 10px">Role*:</label>
                                <div class="col-sm-8">
                                    <c:if test="${param.txtRole == null}">
                                        <input name="txtRole" type="text" class="form-control" value="${dto.role}"
                                               placeholder="(1-Admin; 2-Users; 3-Banned)"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                    <c:if test="${param.txtAddress != null}">
                                        <input name="txtRole" type="text" class="form-control" value="${param.txtRole}"
                                               placeholder="(1-Admin; 2-Users; 3-Banned)"
                                               style="height: 28px !important; position: relative; top: 3px" />
                                    </c:if>
                                </div>
                                <div class="col-sm-4"></div>
                                <label class="col-sm-8" style="color: red;padding-top: 5px"> 
                                    <c:if test="${not empty errors.errRole}">
                                        ${errors.errRole}
                                    </c:if>
                                </label>
                            </div>
