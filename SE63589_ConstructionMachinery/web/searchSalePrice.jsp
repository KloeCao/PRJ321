                ...
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    <form id="searchAllByPrice" class="form-horizontal" action="searchSaleByPrice" style="width: 51%">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input name="txtMinPrice" type="text" class="form-control" value="${requestScope.MINPRICE}"
                            ...
                            <div class="col-sm-3">
                                <input name="txtMaxPrice" type="text" class="form-control" value="${requestScope.MAXPRICE}"
                                       style="height: 28px !important; position: relative; top: 3px" />
                            </div>
                            <div class="col-sm-3">
                    ...
                    <p style="width:50%;text-align:right;color:red;padding-right:40px;">&nbsp;
                        <c:if test="${empty param.txtMinPrice}">
                            Please enter a value at "from"!
                        </c:if>
                    </p>
                    <p style="width:50%;text-align:left;color:red;">&nbsp;
                        <c:if test="${empty param.txtMaxPrice}">
                            Please enter a value at "to"!
                        </c:if>
                    </p>
                </div>
            </div>
                    ...
                    <div id="ttr_content_margin"class="container-fluid">
                        ...
                        <div class="ttr_Projects_html_row0 row" style="padding-top: 10px">
                            ...
                            <c:if test="${not empty minPrice and not empty maxPrice}">
                                <c:set var="result" value="${requestScope.SEARCH_SALE_PRICE}" />
                                ...
                                <c:if test="${empty result}">
                                    <div class="post_column col-lg-12 col-md-12 col-sm-12 col-xs-12" style="height: auto;">
                                        <div class="ttr_Contact-Us_html_column00">
                                            <div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
                                            <div class="html_content"><p style="margin:0em 0em 0em 0em;text-align:Center;"><span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:3.214em;color:#343434;">No results. Try another price.</span></p></div>
                                            <div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
                                            <div style="clear:both;"></div>
                                        </div>
                                    </div>
