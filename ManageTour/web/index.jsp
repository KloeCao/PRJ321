                                ...
                                <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                                    <div href="#">
                                        ...
                                        <div class="desc">
                                            ...
                                            <c:url value="TourMainController" var="viewdetailsLink">
                                                <c:param name="action" value="ViewTourDetails"/>
                                                <c:param name="tourID" value="${tour.tourID}"/>
                                            </c:url>
                                            <a class="btn btn-primary btn-outline" href="${viewdetailsLink}">View More<i class="icon-arrow-right22"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
