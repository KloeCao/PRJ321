 ...
 * @author Kim Anh
 */
public class SearchNearestTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TourDTO> listTour = dao.getNearestTour(today);
            if (listTour != null) {
            ...
            log("Error at SearchNearestTourController: " + e.getMessage());
        } finally {
