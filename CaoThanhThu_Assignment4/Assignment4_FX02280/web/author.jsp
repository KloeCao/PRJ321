            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <form id="contactForm" novalidate 
                        ...
                        <!--Publish-->
                        <p><input type="checkbox" name="chkPublish" value="ON" />Publish this post</p>

                        <!--Button-->
                        <input type="submit" value="Submit Post" name="action" class="btn btn-primary" id="sendMessageButton"/>
                    </form>
                </div>
            </div>
        </div>
