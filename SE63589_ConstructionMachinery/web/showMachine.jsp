...
<html>
    ...
    <body class="KHome Home Projects">
        ...
        <div id="ttr_page" class="container">
            ...
            <div class="ttr_slideshow content">
            ...
            <div class="container">
                <div class="row" style="display: flex;justify-content: center; padding: 20px 0 10px; flex-wrap: wrap">
                    ...
                    <form id="searchAllByPrice" class="form-horizontal" action="searchAllByPrice" style="width: 51%">
                        <div class="form-group">
                ...
                <div id="ttr_content">
                    <div id="ttr_content_margin"class="container-fluid">
                        ...
                        <div class="ttr_Projects_html_row0 row" style="padding-top: 10px">
                            ...
                            <c:set var="allMachine" value="${requestScope.SHOWALL}" />
                            <c:if test="${not empty allMachine}">
                                <c:forEach var="dto" items="${allMachine}" varStatus="counter">
                                        ...
                                        <div class="ttr_Projects_html_column00">
                                            ...
                                            <div class="html_content">
                                                <p style="text-align:Center;">
                                                    <span class="ttr_image" style="float:none;display:block;text-align:center;overflow:hidden;margin:0em 0em 1.43em 0em;">
                                                        <span>
                                                            <img class="ttr_uniform" src="${dto.picture}" style="max-width:350px;max-height:233px;" />
                                                        </span>
                                                    </span>
                                                    <span style="font-family:'Titillium Web','Arial';font-weight:600;font-size:1.429em;">${dto.machineName}</span>
                                                </p>
                                                <p style="margin:0.71em 0em 0.36em 0em;text-align:Center;line-height:1.76056338028169;">
                                                    <span style="font-family:'Verdana';">${dto.description}</span>
                                                </p>
                                                <p style="margin:0.71em 0em 0.36em 0em;text-align:Center;line-height:1.76056338028169;">
                                                    <span><a href="addToCart?txtMachineID=${dto.machineID}" target="_self" class="btn btn-md btn-primary">BUY</a></span>
                                                </p>
                                            </div>
                                            <div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
