 ...
 * @author Kim Anh
 */
public class UpdateStaffInformationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean update = dao.update(staff);
            if(update) {
            ...
            log("Error at UpdateStaffInformationController: " + e.getMessage());
        } finally {
